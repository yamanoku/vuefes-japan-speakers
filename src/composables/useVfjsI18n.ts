...
const translations: Record<"ja" | "en", VfjsTranslations> = {
  ja: {
    ...
    ad_label: "広告",
    event_banner_2026: "Vue Fes Japan 2026は大手町プレイス ホール＆カンファレンスで10/24開催！",
  ...
  en: {
    ...
    event_banner_2026: "Vue Fes Japan 2026 is at Otemachi Place Hall & Conference on October 24!",
